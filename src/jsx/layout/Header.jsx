        ...
        <>
         <header className="top-header">
             <nav className="navbar navbar-expand-xl w-100 navbar-dark container gap-3">
                 <a className="navbar-brand d-none d-xl-inline" href="index.html"><img src="assets/images/logo.webp"
                         className="logo-img" alt="" /></a>
                 ...
                 <div className="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar">
                     ...
                     <div className="offcanvas-body primary-menu">
                         <ul className="navbar-nav justify-content-start flex-grow-1 gap-1">
                             ...
                             <li className="nav-item dropdown">
                                 <a className="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;"
                                     data-bs-toggle="dropdown">
                                     Shop
                                 </a>
                             ...
                             <li className="nav-item dropdown">
                                 ...
                                 <ul className="dropdown-menu">
                                     ...
                                     <li><a className="dropdown-item" href="authentication-reset-password.html">Password</a>
                                     </li>
                                 </ul>
                             </li>
                             <li className="nav-item dropdown">
